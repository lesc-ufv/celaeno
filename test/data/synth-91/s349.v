// Benchmark "s349.bench" written by ABC on Wed Mar 10 23:12:56 2021
...
module s349.bench   clock, 
  ...
  wire new_n66_, new_n68_, new_n70_, new_n71_, new_n72_1_, new_n73_,
    ...
    new_n110_, new_n111_, new_n112_1_, new_n113_, new_n115_, new_n116_,
    ...
    new_n160_, new_n161_, new_n163_, new_n164_, new_n166_, new_n167_, n42,
    n47, n52, n57, n62, n67, n72, n77, n82, n87, n92, n97, n102, n107,
    n112;
  assign new_n66_ = CT1 & CT0;
  assign CNTVCO2 = CT2 & new_n66_;
  assign new_n68_ = CT2 & ~CT1;
  assign READY = CT0 & new_n68_;
  assign new_n70_ = new_n66_ & ~READY;
  assign new_n71_ = ~CT2 & ~new_n70_;
  assign new_n72_1_ = CT2 & new_n70_;
  assign new_n73_ = ~START & ~new_n71_;
  assign n42 = ~new_n72_1_ & new_n73_;
  assign new_n75_ = CT0 & ~READY;
  assign new_n76_ = ~CT1 & ~new_n75_;
  assign new_n77_1_ = CT1 & new_n75_;
  assign new_n78_ = ~START & ~new_n76_;
  assign n47 = ~new_n77_1_ & new_n78_;
  assign new_n80_ = ~CT0 & READY;
  assign new_n81_ = ~START & ~new_n75_;
  assign n52 = ~new_n80_ & new_n81_;
  assign new_n83_ = ~CT2 & ~CT1;
  assign new_n84_ = ~CT0 & new_n83_;
  ...
  assign new_n107_1_ = ~new_n97_1_ & new_n101_;
  assign new_n108_ = new_n97_1_ & new_n99_;
  assign new_n109_ = new_n102_1_ & ~new_n108_;
  assign new_n110_ = ~new_n107_1_ & ~new_n109_;
  assign new_n111_ = new_n85_ & ~new_n110_;
  assign new_n112_1_ = ~ACVQN2 & ~new_n85_;
  assign new_n113_ = ~new_n111_ & ~new_n112_1_;
  assign n62 = START | new_n113_;
  assign new_n115_ = ~new_n92_1_ & new_n96_;
  assign new_n116_ = new_n92_1_ & new_n94_;
  assign new_n117_ = new_n97_1_ & ~new_n116_;
  assign new_n118_ = ~new_n115_ & ~new_n117_;
  assign new_n119_ = new_n85_ & ~new_n118_;
  assign new_n120_ = ~ACVQN1 & ~new_n85_;
  assign new_n121_ = ~new_n119_ & ~new_n120_;
  assign n67 = START | new_n121_;
  assign new_n123_ = new_n87_1_ & new_n91_;
  assign new_n124_ = ~new_n87_1_ & new_n89_;
  assign new_n125_ = new_n92_1_ & ~new_n124_;
  assign new_n126_ = ~new_n123_ & ~new_n125_;
  assign new_n127_ = new_n85_ & ~new_n126_;
  assign new_n128_ = ~ACVQN0 & ~new_n85_;
  assign new_n129_ = ~new_n127_ & ~new_n128_;
  assign n72 = START | new_n129_;
  assign new_n131_ = B3 & ~READY;
  assign new_n132_ = ~MRVQN3 & READY;
  assign new_n133_ = ~new_n131_ & ~new_n132_;
  assign new_n134_ = ~new_n85_ & ~new_n133_;
  assign new_n135_ = ACVQN0 & ~new_n86_;
  assign new_n136_ = ~new_n87_1_ & ~new_n135_;
  assign new_n137_ = new_n85_ & new_n136_;
  assign n77 = ~new_n134_ & ~new_n137_;
  assign new_n139_ = B2 & ~READY;
  assign new_n140_ = ~MRVQN2 & READY;
  assign new_n141_ = ~new_n139_ & ~new_n140_;
  assign new_n142_ = ~new_n85_ & ~new_n141_;
  assign new_n143_ = ~MRVQN3 & new_n85_;
  assign n82 = ~new_n142_ & ~new_n143_;
  assign new_n145_ = B1 & ~READY;
  assign new_n146_ = ~MRVQN1 & READY;
  assign new_n147_ = ~new_n145_ & ~new_n146_;
  assign new_n148_ = ~new_n85_ & ~new_n147_;
  assign new_n149_ = ~MRVQN2 & new_n85_;
  assign n87 = ~new_n148_ & ~new_n149_;
  assign new_n151_ = B0 & ~READY;
  assign new_n152_ = ~MRVQN0 & READY;
  assign new_n153_ = ~new_n151_ & ~new_n152_;
  assign new_n154_ = ~new_n85_ & ~new_n153_;
  assign new_n155_ = ~MRVQN1 & new_n85_;
  assign n92 = ~new_n154_ & ~new_n155_;
  assign new_n157_ = A3 & new_n84_;
  assign new_n158_ = AX3 & ~new_n84_;
  assign n97 = new_n157_ | new_n158_;
  assign new_n160_ = A2 & new_n84_;
  assign new_n161_ = AX2 & ~new_n84_;
  assign n102 = new_n160_ | new_n161_;
  assign new_n163_ = A1 & new_n84_;
  assign new_n164_ = AX1 & ~new_n84_;
  assign n107 = new_n163_ | new_n164_;
  assign new_n166_ = A0 & new_n84_;
  assign new_n167_ = AX0 & ~new_n84_;
  assign n112 = new_n166_ | new_n167_;
